 ...
 */
contract UsdfiVaultV2 is ERC20Upgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function depositAll() external {
        depositFor(msg.sender, want().balanceOf(msg.sender));
    }
     ...
     */
    function depositFor(address _user, uint _amount) public nonReentrant {
